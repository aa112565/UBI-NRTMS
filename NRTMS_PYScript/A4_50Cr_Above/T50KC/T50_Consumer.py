...
def to_wf(rec,amt_thres):
    ...
    msg = 'It is observed that high value credit/debit of Rs. '+rec['tran_amt']+' happened in the account No '+rec['foracid']+' name '+rec['acct_name']+' on '+rec['tran_date']+', Kindly scrutinize the transactions against the profile of the customer for genuineness & source of funds'
